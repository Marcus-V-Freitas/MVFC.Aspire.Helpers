...
/// incluindo o container do emulador, a interface de administração (UI) e a configuração do Pub/Sub.
/// </summary>
/// <param name="Emulator">
...
/// </param>
/// <param name="PubSubConfig">
/// Configuração do Pub/Sub, incluindo o ID do projeto, tópicos, assinaturas e delay de inicialização.
/// </param>
