...
public static class MongoExtensions {
    private const int HOST_PORT = 27017;
    ...
    /// <param name="image">Nome da imagem Docker utilizada para o emulador Mongo.</param>
    ...
    public static IResourceBuilder<ContainerResource> AddMongoReplicaSet(
        ...
        string name,
        string image = DEFAULT_MONGO_IMAGE,
        string tag = "latest",
        ...
        return builder.AddContainer(name, BuildDockerImage(image, tag))
                      .WithArgs("--replSet", "rs0", "--bind_ip_all")
                      .AddContainerVolume(volumeName)
                      .WithEndpoint(HOST_PORT, HOST_PORT, "mongodb", isProxied: false, isExternal: true)
